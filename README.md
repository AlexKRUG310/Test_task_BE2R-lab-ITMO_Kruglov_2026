...
Подробный анализ данных статей c рассмотрением недостатков каждого решения и гипотезами для их преодоления содержится в файле Test_task_Kruglov_A.S.pdf
...
Далее приведено развитие политики на разных стадиях обучения.
...
Всего было выполнено 1322 итерации.

### Тестирование
Ниже приведено тестирование обученной политики в симуляции:
![Тестирование](Demonstrations/Testing.gif)

Подробное описание метрик обучения и тестирования приведено в разделе "Практическая реализация метода Fine-Tuning" документа Test_task_Kruglov_A.S.pdf
