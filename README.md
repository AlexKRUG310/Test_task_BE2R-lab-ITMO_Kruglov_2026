...
### Тестирование
Ниже преведено тестирование обученной политики в симуляции:
![Тестирование](Demonstrations/Testing.gif)

Подроное описание метрик обучения и тестирования преведены в разделе "Практическая реализация метода Fine-Tuning" документа Test_task_Kruglov_A.S.pdf
